...
/* Generated from ../O.Common/E5GN.dbd */
...
int E5GN_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/epics/synApps_5_8/support/instruments/e5gn";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"E5GN_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    E5GN_registerRecordDeviceDriver(*iocshPpdbbase);
}
