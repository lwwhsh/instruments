...
/* Generated from ../O.Common/temp_gpib.dbd */
...
epicsShareExtern dset *pvar_dset_devAitemp_gpib;
...
epicsShareExtern dset *pvar_dset_devAotemp_gpib;
...
epicsShareExtern dset *pvar_dset_devBitemp_gpib;
...
epicsShareExtern dset *pvar_dset_devBotemp_gpib;
...
epicsShareExtern dset *pvar_dset_devEvtemp_gpib;
...
epicsShareExtern dset *pvar_dset_devLitemp_gpib;
...
epicsShareExtern dset *pvar_dset_devLotemp_gpib;
...
epicsShareExtern dset *pvar_dset_devMbbitemp_gpib;
...
epicsShareExtern dset *pvar_dset_devMbbidtemp_gpib;
...
epicsShareExtern dset *pvar_dset_devMbbotemp_gpib;
...
epicsShareExtern dset *pvar_dset_devMbbodtemp_gpib;
...
epicsShareExtern dset *pvar_dset_devSitemp_gpib;
...
epicsShareExtern dset *pvar_dset_devSotemp_gpib;
...
epicsShareExtern dset *pvar_dset_devWftemp_gpib;
epicsShareExtern dset *pvar_dset_devXxxSoft;
epicsShareExtern dset *pvar_dset_asynRecordDevice;

static const char * const deviceSupportNames[96] = {
    "devAaiSoft",
    "devAaoSoft",
    "devAiSoft",
    "devAiSoftRaw",
...
static const dset * const devsl[96] = {
...
epicsShareExtern void (*pvar_func_register_func_temp_gpibSubInit)(void);
epicsShareExtern void (*pvar_func_register_func_temp_gpibSubProcess)(void);
...
epicsShareExtern int *pvar_int_temp_gpibSubDebug;
static struct iocshVarDef vardefs[] = {
	...
	{"temp_gpibSubDebug", iocshArgInt, (void * const)pvar_int_temp_gpibSubDebug},
	{NULL, iocshArgInt, NULL}
};

int temp_gpib_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/epics/synApps_5_8/support/instruments/temp_gpib";
    ...
    (*pvar_func_register_func_temp_gpibSubInit)();
    (*pvar_func_register_func_temp_gpibSubProcess)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"temp_gpib_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    temp_gpib_registerRecordDeviceDriver(*iocshPpdbbase);
}
