...
/* Generated from ../O.Common/tilt.dbd */
...
int tilt_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/epics/synApps_5_8/support/instruments/tiltMeter";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"tilt_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    tilt_registerRecordDeviceDriver(*iocshPpdbbase);
}
