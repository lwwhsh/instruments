...
epicsEnvSet("IOC_NAME","HL3B:VBC3H")
...
epicsEnvSet("LOCATION","BC3H")

# tag log messages with IOC name
# How to escape the "sioc-bc3h-vac" as the PERL program
...
drvAsynIPPortConfigure("A1","ts-bc3h-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

drvAsynIPPortConfigure("A2","ts-bc3h-dev1:4008 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_2","A2",0x80,2,0)

drvAsynIPPortConfigure("M1","ts-bc3h-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

#asynOctetSetInputEos("M1",0,";FF")
#asynOctetSetOutputEos("M1",0,";FF")

dbLoadTemplate("db/bc3h_agilent4uhv.substitutions")
dbLoadTemplate("db/bc3h_mks937b.substitutions")
