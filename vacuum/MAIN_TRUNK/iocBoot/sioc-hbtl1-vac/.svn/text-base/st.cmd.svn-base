...
epicsEnvSet("IOC_NAME","HBTL:HBTL1")
...
epicsEnvSet("LOCATION","HBTL1")

# tag log messages with IOC name
# How to escape the "sioc-hbtl1-vac" as the PERL program
...
drvAsynIPPortConfigure("M1","ts-l429-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("A1","ts-l429-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

drvAsynIPPortConfigure("A2","ts-l429-dev1:4008 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_2","A2",0x80,2,0)

dbLoadTemplate("db/hbtl1_mks937b.substitutions")
dbLoadTemplate("db/hbtl1_agilent4uhv.substitutions")
