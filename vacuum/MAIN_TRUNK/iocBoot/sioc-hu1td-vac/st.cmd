...
epicsEnvSet("IOC_NAME","HBTL:HU1TD")
...
epicsEnvSet("LOCATION","HU1TD")

# tag log messages with IOC name
# How to escape the "sioc-hu1td-vac" as the PERL program
...
drvAsynIPPortConfigure("M1","ts-hu1td-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("A1","ts-hu1td-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

dbLoadTemplate("db/hu1td_mks937b.substitutions")
dbLoadTemplate("db/hu1td_agilent4uhv.substitutions")
