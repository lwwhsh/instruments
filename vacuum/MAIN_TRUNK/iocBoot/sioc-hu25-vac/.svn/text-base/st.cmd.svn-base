...
epicsEnvSet("LOCATION","HU25")

# tag log messages with IOC name
# How to escape the "sioc-hu25-vac" as the PERL program
...
drvAsynIPPortConfigure("M1","ts-hu2526-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("A1","ts-hu2526-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

dbLoadTemplate("db/hu2526_mks937b.substitutions")
dbLoadTemplate("db/hu2526_agilent4uhv.substitutions")
