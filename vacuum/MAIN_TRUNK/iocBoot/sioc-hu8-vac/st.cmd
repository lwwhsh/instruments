...
epicsEnvSet("IOC_NAME","HU1:HU-8/9")
...
epicsEnvSet("LOCATION","HU-8/9")

# tag log messages with IOC name
# How to escape the "sioc-hu8-vac" as the PERL program
...
drvAsynIPPortConfigure("M1","ts-hu89-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("A1","ts-hu89-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)
drvAsynIPPortConfigure("A2","ts-hu89-dev1:4008 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_2","A2",0x80,2,0)

dbLoadTemplate("db/hu89_mks937b.substitutions")
dbLoadTemplate("db/hu89_agilent4uhv.substitutions")
