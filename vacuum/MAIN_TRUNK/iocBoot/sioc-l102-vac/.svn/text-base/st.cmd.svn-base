...
epicsEnvSet("IOC_NAME","HL1:VL102")
...
epicsEnvSet("LOCATION","L102")

# tag log messages with IOC name
# How to escape the "sioc-l102-vac" as the PERL program
...
drvAsynIPPortConfigure("A1","ts-l102-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

drvAsynIPPortConfigure("A2","ts-l102-dev1:4008 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_2","A2",0x80,2,0)

drvAsynIPPortConfigure("A3","ts-l102-dev1:4009 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_3","A3",0x80,2,0)

drvAsynIPPortConfigure("M1","ts-l102-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("M2","ts-l102-dev1:4006 TCP",0,0,0)
...
dbLoadTemplate("db/l102_agilent4uhv.substitutions")
dbLoadTemplate("db/l102_mks937b.substitutions")
