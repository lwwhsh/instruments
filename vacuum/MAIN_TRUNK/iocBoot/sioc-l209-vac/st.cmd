...
epicsEnvSet("IOC_NAME","HL2:VL209")
...
epicsEnvSet("LOCATION","L209")

# tag log messages with IOC name
# How to escape the "sioc-l209-vac" as the PERL program
...
drvAsynIPPortConfigure("A1","ts-l209-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

drvAsynIPPortConfigure("A2","ts-l209-dev1:4008 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_2","A2",0x80,2,0)

drvAsynIPPortConfigure("M1","ts-l209-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

#asynOctetSetInputEos("M1",0,";FF")
#asynOctetSetOutputEos("M1",0,";FF")

dbLoadTemplate("db/l209_agilent4uhv.substitutions")
dbLoadTemplate("db/l209_mks937b.substitutions")
