...
epicsEnvSet("IOC_NAME","HBTL:VBTL")
...
# How to escape the "sioc-l428-vac" as the PERL program
...
drvAsynIPPortConfigure("M1","ts-l428-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("A1","ts-l428-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

dbLoadTemplate("db/l428_mks937b.substitutions")
dbLoadTemplate("db/l428_agilent4uhv.substitutions")
