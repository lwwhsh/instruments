...
epicsEnvSet("IOC_NAME","HL2:VBC2H")
...
epicsEnvSet("LOCATION","BC2H")

# tag log messages with IOC name
# How to escape the "sioc-bc2h-vac" as the PERL program
...
drvAsynIPPortConfigure("A1","ts-bc2-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

drvAsynIPPortConfigure("M1","ts-bc2-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

#asynOctetSetInputEos("M1",0,";FF")
#asynOctetSetOutputEos("M1",0,";FF")

dbLoadTemplate("db/bc2h_agilent4uhv.substitutions")
dbLoadTemplate("db/bc2h_mks937b.substitutions")
