...
epicsEnvSet("IOC_NAME","HU1E:HU1E")
...
epicsEnvSet("LOCATION","HU1E")

# tag log messages with IOC name
# How to escape the "sioc-hu1e-vac" as the PERL program
...
drvAsynIPPortConfigure("M1","ts-hu1e-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

drvAsynIPPortConfigure("A1","ts-hu1e-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

dbLoadTemplate("db/hu1e_mks937b.substitutions")
dbLoadTemplate("db/hu1e_agilent4uhv.substitutions")
