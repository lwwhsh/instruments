...
epicsEnvSet("IOC_NAME","SBTL:VSU1TD")
...
epicsEnvSet("LOCATION","SU1TD")

# tag log messages with IOC name
# How to escape the "sioc-su1td-vac" as the PERL program
...
drvAsynIPPortConfigure("A1","ts-su1td-dev1:4007 TCP",0,0,0)
drvAgilent4uhvConfigure("4uhv_1","A1",0x80,2,0)

drvAsynIPPortConfigure("M1","ts-su1td-dev1:4005 TCP",0,0,0)
drvMks937bConfigure("mks1","M1",253,2,0)

#asynOctetSetInputEos("M1",0,";FF")
#asynOctetSetOutputEos("M1",0,";FF")

dbLoadTemplate("db/su1td_agilent4uhv.substitutions")
dbLoadTemplate("db/su1td_mks937b.substitutions")
