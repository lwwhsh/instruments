...
/* Generated from ../O.Common/vac.dbd */
...
epicsShareExtern void (*pvar_func_drvAgilent4uhvConfigureRegister)(void);
epicsShareExtern void (*pvar_func_drvMks937bConfigureRegister)(void);
...
int vac_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/usr/local/xfel/epics/iocTop/vacuum/MAIN_TRUNK";
    ...
    (*pvar_func_drvAgilent4uhvConfigureRegister)();
    (*pvar_func_drvMks937bConfigureRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"vac_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    vac_registerRecordDeviceDriver(*iocshPpdbbase);
}
